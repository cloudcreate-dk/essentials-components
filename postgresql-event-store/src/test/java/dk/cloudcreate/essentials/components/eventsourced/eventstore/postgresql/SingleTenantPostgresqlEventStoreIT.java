...
class SingleTenantPostgresqlEventStoreIT {
    ...
    void setup() {
        ...
        var persistenceStrategy = new SeparateTablePerAggregateTypePersistenceStrategy(jdbi,
                                                                                       unitOfWorkFactory,
                                                                                       eventMapper,
                                                                                       List.of(standardSingleTenantConfigurationUsingJackson(aggregateType,
                                                                                                                                             createObjectMapper(),
    ...
    void persisting_events_related_to_two_different_aggregates_in_one_unitofwork() {
        ...
        assertThat(lastPersistedEventOrder1.get().eventRevision()).isEqualTo(EventRevision.of(1));
        ...
        assertThat(lastPersistedEventOrder1.get().event().getJson()).isEqualTo("{\"orderId\": \"beed77fb-d911-1111-9c48-03ed5bfe8f89\", \"orderNumber\": 1234, \"orderingCustomerId\": \"Test-Customer-Id-10\"}"); // Note formatting changed by postgresql
        ...
        assertThat(lastPersistedEventOrder2.get().eventRevision()).isEqualTo(EventRevision.of(1));
        ...
        assertThat(lastPersistedEventOrder2.get().event().getJson()).isEqualTo("{\"orderId\": \"ceed77fb-d911-9c48-1111-03ed5bfe8f89\", \"orderNumber\": 4321, \"orderingCustomerId\": \"Test-Customer-Id2-10\"}"); // Note formatting changed by postgresql
    ...
    void loadLastPersistedEventRelatedTo__before_and_after_persisting_an_event() {
        ...
        assertThat(lastPersistedEvent.get().eventRevision()).isEqualTo(EventRevision.of(1));
        ...
        assertThat(lastPersistedEvent.get().event().getJson()).isEqualTo("{\"orderId\": \"beed77fb-d911-1111-9c48-03ed5bfe8f89\", \"orderNumber\": 1234, \"orderingCustomerId\": \"Test-Customer-Id-10\"}"); // Note formatting changed by postgresql
    ...
    void loadEvent() {
        ...
        assertThat(specificEvent.get().eventRevision()).isEqualTo(EventRevision.of(1));
    ...
    void persist_and_load_a_single_event() {
        ...
        assertThat(eventsPersisted.get(0).eventRevision()).isEqualTo(EventRevision.of(1));
    ...
    void append_events_to_existing_aggregate_eventstream() {
        ...
        assertThat(eventsAppended.get(0).eventRevision()).isEqualTo(EventRevision.of(1));
        ...
        assertThat(eventsAppended.get(1).eventRevision()).isEqualTo(EventRevision.of(1));
        ...
        assertThat(eventsLoaded.get(2).eventRevision()).isEqualTo(EventRevision.of(1));
    ...
    void append_events_to_with_overlapping_event_order() {
        ...
        unitOfWorkFactory.getCurrentUnitOfWork().get().rollback();
    ...
    void test_inMemory_Projection() {
        ...
        assertThat(eventsInProjection.get(0).eventRevision()).isEqualTo(EventRevision.of(1));
        ...
        assertThat(eventsInProjection.get(0).event().getJson()).isEqualTo("{\"orderId\": \"beed77fb-1115-1115-9c48-03ed5bfe8f89\", \"orderNumber\": 1234, \"orderingCustomerId\": \"Test-Customer-Id-15\"}"); // Note formatting changed by postgresql
        ...
        assertThat(eventsInProjection.get(1).eventRevision()).isEqualTo(EventRevision.of(1));
        ...
        assertThat(eventsInProjection.get(2).eventRevision()).isEqualTo(EventRevision.of(1));
    ...
    void test_loadEventsByGlobalOrder() {
        ...
        eventStore.addAggregateTypeConfiguration(standardSingleTenantConfigurationUsingJackson(PRODUCTS,
                                                                                               createObjectMapper(),
    ...
    void test_pollEvents() {
        ...
        var productEventsFlux = eventStore.pollEvents(PRODUCTS,
                                                      ...
                                                      Optional.empty(),
                                                      Optional.of(SubscriberId.of("ProductsSub1")))
                                          .subscribe(e -> {
        ...
        var orderEventsFlux = eventStore.pollEvents(ORDERS,
                                                    ...
                                                    Optional.of(Duration.ofMillis(100)),
                                                    Optional.empty(),
                                                    Optional.of(SubscriberId.of("OrdersSub1")))
                                        .subscribe(e -> {
