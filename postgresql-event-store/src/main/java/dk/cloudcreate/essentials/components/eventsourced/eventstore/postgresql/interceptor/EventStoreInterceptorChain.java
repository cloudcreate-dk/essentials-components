...
public interface EventStoreInterceptorChain<OPERATION, RESULT> {
     ...
     */
    static <OPERATION, RESULT> EventStoreInterceptorChain<OPERATION, RESULT> newChainForOperation(OPERATION operation,
    ...
    /**
     * Default implementation for the {@link EventStoreInterceptorChain}. It's recommended to use {@link EventStoreInterceptorChain#newChainForOperation(Object, List, BiFunction, Supplier)} to create an new chain
    ...
    class DefaultEventStoreInterceptorChain<OPERATION, RESULT> implements EventStoreInterceptorChain<OPERATION, RESULT> {
        ...
        public RESULT proceed() {
            if (interceptorIterator.hasNext()) {
                return interceptorMethodInvoker.apply(interceptorIterator.next(), this);
            } else {
